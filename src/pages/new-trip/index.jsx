          ...
          <div className="pt-24">
            <div className="flex w-full items-start justify-end gap-2 px-4 md:px-12">
              <div className="mx-auto">
                ...
                <p className="mt-5 text-center text-sm text-gray-600 opacity-75">
